...
return new Level6\Diagram('Diagram', [
    ...
    new Level6\Attribute('id', 'no', 'yes', 'int'),
    new Level6\Attribute('id', 'no', 'yes', 'int'),
    new Level6\Attribute('id', 'no', 'yes', 'int'),
    new Level6\Attribute('id', 'no', 'yes', 'int'),
    new Level6\Attribute('multiple', 'no', 'no', 'bool'),
    new Level6\Attribute('iskey', 'no', 'no', 'bool'),
    new Level6\Attribute('multiple', 'no', 'no', 'bool'),
    new Level6\Attribute('iskey', 'no', 'no', 'bool'),
    new Level6\Attribute('type', 'no', 'no', 'mixed'),
    new Level6\Attribute('type', 'no', 'no', 'mixed'),
], [
    new Level6\RelationAttribute('min', 'no', 'no', 'int'),
    new Level6\RelationAttribute('max', 'no', 'no', 'int?'),
    new Level6\RelationAttribute('existence', 'no', 'no', 'bool'),
